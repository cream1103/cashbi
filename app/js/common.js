...
//липкий сайдбар
    ...
    function windowSize() {
        if ($(window).width() < 600) {
            $('.select2-search__field').attr('placeholder', 'Найти свой магазин');
        } else {
            $('.select2-search__field').attr('placeholder', 'Найти свой магазин, например SAPATO');
        }
    }
